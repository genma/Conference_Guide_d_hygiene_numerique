...
\item Êtes vous sûr que c'est bien votre banque?
}
\end{itemize}
\end{block}
...
\item Uniquement les logiciels dont on a besoin (pas de démos, de logiciels marrants...)
\end{itemize}
\end{block}
...
\item Évitez les sites de Warez, de porno, les installations de logiciels piochés à gauche et à droite sur la toile, les clés USB.
...
\begin{itemize}
\justifying{
\item Éviter les sites sur lesquels on sait des données personnelles : webmail, réseaux sociaux
